export const activityMock = JSON.parse(
...
export const averageSessionsMock = JSON.parse(
...
export const performanceMock = JSON.parse(
...
export const userMock = JSON.parse(
